...
public class ICategoriaDao implements InterfaceDao{

	@Override
	public void guardar(Object o) {
		Categoriaart guardar=(Categoriaart)o;
	...
	public void actualizar(Object o) {
		 Categoriaart actualizar=(Categoriaart)o;
		Session ses=HibernateUtil.getSessionFactory().openSession();
		Transaction t= ses.beginTransaction();
	...
	public Object darEntidad(long id) {
		Session ses= HibernateUtil.getSessionFactory().openSession();
		return (Categoriaart)ses.load(Categoriaart.class, id);
	...
	public List<Object> darLista() {
		Session ses=HibernateUtil.getSessionFactory().openSession();
		Transaction t= ses.beginTransaction();
		List<Object> r= ses.createQuery("from Categoriaart").list();
		t.commit();
		return r;
